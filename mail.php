...
<div class="col-md-12">
    ...
    <div class="panel panel-flat">
        <table class="table datatable-basic mails-table">
            ...
            <tbody>
					<tr onclick="window.location='http://localhost/panel/mail/<?php echo $email->id ?>';">
						<td><?php echo $email->name ; ?></td>
						<td colspan="2"><b><?php echo $email->subject ; ?></b>- <?php echo App::get_snippet($email->message, 10).'...'; ?></td>
						<td class="text-center">
							<a class='delete_msg' email-id-data=''><i class="icon-trash"></i></a>
						</td>
