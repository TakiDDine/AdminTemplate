            ...
            <div class="content">
                        ...
                        <div class="panel panel-flat">
								<div class="panel-heading">
									<h2 class="panel-title">مرحبا بك في لوحة التحكم ! <br><small>جمعنا لك بعض الروابط لمساعدتك على البدء:</small></h2>
								</div>
								...
								<ul class="col-md-6 list list-icons">
                                       <h4>الخطوات الأولى !</h4>
                                        <li>
											<a href="http://localhost/panel/add-new-article"><i class="icon-plus3"></i>    اكتب مقالتك الأولى</a>
										</li>
										<li>
											<a href="http://localhost/panel/add-new-page"><i class="icon-plus3"></i> اضف صفحتك الجديدة</a>
										</li>
								</ul>
								
									<ul class='col-md-6 list list-icons'>
									<h4>المزيد من الإجراءات !</h4>
										<li>
											<a href=""><i class="icon-gear"></i> اعداد لوحة التحكم </a>
										</li>
										<li>
											<a href=""><i class="icon-comment-discussion"></i> إتاحة أو منع التعليقات</a>
										</li>																				
									</ul>									
								</div>
							</div>
...
<table class="table">
										<tbody>
											<tr class="active border-double">
												<td colspan="2"><b>أحدث التعليقات</b></td>
												<td class="text-right">
												</td>
											</tr>
											<?php for($x=0;$x<4;$x++) { ?>
