            ...
            <div class="content">
                ...
                <div class="panel panel-flat col-md-12">
                    <div class="panel-heading no-padding-bottom">
                        <h3 class="panel-title">الإعدادات</h3>
                        ...
                        <form class="form-horizontal" method="post" onsubmit="return false;" id="GENERAL_SETTINGS_FORM">
                            <fieldset class="content-group">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-lg-3">اسم المستخدم	</label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-block active no-marin-bottom" id="SubmitSettingsForm">تحديث المعلومات</button>
                                </div>
                            </fieldset>
                        </form>
                    </div>
                ...
                <div class="panel panel-flat col-md-12">
                    <div class="panel-heading no-padding-bottom">
                        <h3 class="panel-title">كلمة المرور</h3>
                        <p class="no-margin-bottom">المرجوا ادخال المعلومات التالية بعناية</p>
                    </div>
                    <div class="panel-body">
                        <form class="form-horizontal" method="post" onsubmit="return false;" id="GENERAL_SETTINGS_FORM">
                            <fieldset class="content-group">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-lg-3">كلمة المرور الجديدة		</label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" value='' name="name" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-lg-3">إعادة كلمة المرور الجديدة			</label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" value='' name="name" />
                                    </div>
                                </div>                                
                                <div class="form-group">
                                    <input type="hidden" name="validate" value='validate_my_settings' />
                                                            <button type="submit" class="btn btn-primary btn-block active" id="SubmitSettingsFormPassword">تحديث كلمة المرور</button>
