...
<div class="col-md-12">
	<div class="panel panel-flat col-md-12">
		<div class="panel-heading no-padding-bottom">
			<h3 class="panel-title">إعلانات الموقع</h3>
			<p class="no-margin-bottom">المرجوا ادخال كود الإعلانات في الخانات التالية بعناية</p>
		</div>
			...
			<form class="form-horizontal" method="post" onsubmit="return false;" id="GENERAL_SETTINGS_FORM">
				<fieldset class="content-group">
					...
					<div class="form-group">
						<label class="control-label col-lg-3">اّلإعلان الأول</label>
						<div class="col-lg-9">
							<textarea name="keywords" class="form-control" rows="3"></textarea>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-lg-3">اّلإعلان الثاني</label>
						<div class="col-lg-9">
							<textarea name="keywords" class="form-control" rows="3"></textarea>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-lg-3">اّلإعلان الثالث</label>
						<div class="col-lg-9">
							<textarea name="keywords" class="form-control" rows="3"></textarea>
						</div>
					</div>										
					<div class="form-group">
						<label class="control-label col-lg-3">اّلإعلان الرابع</label>
						<div class="col-lg-9">
							<textarea name="keywords" class="form-control" rows="3"></textarea>
						</div>
					</div>					
					<div class="form-group">
						<label class="control-label col-lg-3">اّلإعلان الخامس</label>
						<div class="col-lg-9">
							<textarea name="keywords" class="form-control" rows="3"></textarea>
						</div>
					</div>	
