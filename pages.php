...
<div class="col-md-6 text-left">
    <h1 class="no-margin-top">الصفحات</h1>
</div>
<div class="col-md-6 text-right">
    <a href="" class="btn bg-brown">
        <i class="icon-plus3 position-left"></i>اضافة صفحة جديدة</a>
</div>
...
<div class="col-md-12">
    <div class="panel panel-flat">
        <table class="table datatable-basic">
            <thead>
                <tr>
                    <th class="col-md-7"><b> العنوان </b></th>
                    <th class="col-md-2"><b>الكاتب </b></th>
                    <th class="col-md-2"><b>التاريخ</b></th>
            ...
            <tbody>
                <tr>
                    ...
                    <td><a href="#"></a></td>
                    <td>
                        <label class="label bg-success">منشور</label>
                        <label class="label bg-purple">مسودة</label>
                        <label class="label label-danger">محذوف</label>
                    </td>
                    <td class="text-center">
                        <ul class="icons-list">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a class="text-success show_cmt"><i class="icon-eye"></i><b>عرض التعليق</b></a></li>
                                    <li><a class=""><i class="icon-eye-blocked"></i><b>اخفاء التعليق </b></a></li>
